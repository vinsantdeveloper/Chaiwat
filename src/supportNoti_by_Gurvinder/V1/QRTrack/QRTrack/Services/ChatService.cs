...
namespace QRTrack.Services
{
    public class ChatService : IChatService
    {
        ...
        public async Task CreateConnection()
        {
            ...
            var result = await httpClient.GetStringAsync("https://qpickfunctions.azurewebsites.net/api/GetSignalRInfo");
        ...
        public async Task SendMessage(Message message)
        {
            ...
            await httpClient.PostAsync("https://qpickfunctions.azurewebsites.net/api/messages", content);
        }
