...
extern void *mono_aot_module_QRTrack_iOS_info;
extern void *mono_aot_module_mscorlib_info;
extern void *mono_aot_module_QRTrack_info;
...
extern void *mono_aot_module_QRTrack_Chat_Messages_info;
...
{
	mono_aot_register_module (mono_aot_module_QRTrack_iOS_info);
	mono_aot_register_module (mono_aot_module_mscorlib_info);
	mono_aot_register_module (mono_aot_module_QRTrack_info);
	...
	mono_aot_register_module (mono_aot_module_QRTrack_Chat_Messages_info);
...
void xamarin_setup_impl ()
{
	...
	xamarin_executable_name = "QRTrack.iOS.exe";
	mono_use_llvm = FALSE;
	xamarin_log_level = 0;
